...
<html>
			...
			function menu(obj){
				...
				var ar = document.getElementById("menu").getElementsByTagName("ol");
					if(el.style.display != "block"){
						...
						if(el != "sousmenu1"){document.getElementById("activeRoutes").style.display="none";}
					}else{
						el.style.display = "none";
						document.getElementById("activeRoutes").style.display="none";
					}
				}
			}
	...
	<body id="page">
		<div id="main">
				...
				<div id = "stylesousmenu">
					<ol>
						<li>
							...
							<li class="styletext"> <input id="startStation" type="text" placeholder="Arrêt..." class="ppfix pre marker black"/> </li> <br/>
							<li class="styletext"> Sélectionnez les lignes actives: </li><br/>
							<!--<li class="styletext">
								<form action="#" class="styletext" name="frm">
									<input type="checkbox" name="list[]" id="list0" value="valeur1" checked="check" onclick="toggleBusActivity(this.checked)"/>Bus
									<input type="checkbox" name="list[]" id="list1" value="valeur2" checked="check"onclick="toggleSubwayActivity(this.checked)"/>Métro
							        <input type="checkbox" name="list[]" id="list2" value="valeur3" checked="check" onclick="toggleTramwayActivity(this.checked)"/>Tramway
								   
									<input type="checkbox" value="Cocher tout" id="cocher_tout" checked="check" onclick="cocher(this.check)" />
										 Toutes
								</form>
							</li>-->
							<li class="styletext">
							...
							<li>
							<input class = "styletext" style="text-decoration:underline;font-family : arial,verdana,sans-serif; font-size: 14px;color: #ffffff;margin-left:50px; font-weight:bold; border-radius:0px" type="button" value="Activer / désactiver les lignes" onclick="showmenu(document.getElementById('activeRoutes'));"/>
							<br/></li><br/>
							<li class="styletext"> 
								<div class="zoom">
						...
						<li>
							<ol class="sousmenu" id="sousmenu4"><br/>
								...
								<!--<div id="hourslider" style="margin-left:100px">
									<label for="startHour">Heure de départ <br/></label> 
									<input type="text" name="startHour"	id="startHour" style="border: 0; color: #f6931f; font-weight: bold; width: 100%; text-align: center;"/>
									<input type="text" name="startHour" id="startHour" style="width: 20%; color: #000000; text-align: center" />
									<br/><br/><br/>		
								</div>-->
			...
			<div id="menuSlide">
				<br/>
				Temps de trajet : <input type="texte" id="maxMinute" style="border: 0; color: gray; font-weight: bold; width: 100px; text-align: center;">	<br/>		
				<div id="slider-minute-vertical" style="height: 10px; margin: 20px;"></div>
				Date : <input type="text" id="datepicker" /></br><br/><br/>
				Partir à <input type="texte" name="startHour" id="startHour" style="border: 0; color: gray; font-weight: bold; width: 100px; text-align: center;">
	...
	-->
			<div id="controladv" style="display: none;">
				...
				<!-- PEDROLITO - WTF is that shit ? -->
					Désactiver les lignes :<br/>
					<div id="activeRoutes2">
