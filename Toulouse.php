...
<html>
	...
	<body id="page">
			...
			<div id="topnav">
				...
				<div id="buttons">
					...
					<div id="buttonsadv" style="display: none">
						...
						<a class="orange5 awesome"
							style="float: right" href="javascript:toggleLineMovie();">
							<span class="video" id="lineMovie">L'état du réseau</span> 
						</a>
					</div>
		...
		<div style="display: none">
			<div id="moreinfo">
				<h2>Vizurbi! Le réseau Tisséo en un coup d'&oelig;il</h2>
				<br />
